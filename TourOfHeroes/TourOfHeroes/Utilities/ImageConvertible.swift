...
public extension UIImageView {
    var imageConvertible: ImageConvertible? {
        get { return image }
        set {
...
public protocol ImageConvertible {
    ...
    func equal(to other: ImageConvertible) -> Bool
}

extension Optional where Wrapped == ImageConvertible {
    public func equal(to other: ImageConvertible?) -> Bool {
