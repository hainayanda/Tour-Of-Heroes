...
extension NamadaLayoutable {
    ...
    @discardableResult
    public func center(_ relation: LayoutRelation<CoordinateOffsets>, to view: UIView, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func center(_ relation: LayoutRelation<CoordinateOffsets>, to parent: ParentRelated, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func vertical(_ relation: LayoutRelation<InsetsConvertible>, to parent: ParentRelated, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func vertical(_ relation: LayoutRelation<InsetsConvertible>, to view: UIView, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func horizontal(_ relation: LayoutRelation<InsetsConvertible>, to view: UIView, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func horizontal(_ relation: LayoutRelation<InsetsConvertible>, to parent: ParentRelated, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func edges(_ relation: LayoutRelation<InsetsConvertible>, to parent: ParentRelated, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func size(_ relation: InterRelation<CGSize>, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func size(_ relation: InterRelation<UIView>, multiplyBy multipier: CGFloat = 1, constant: CGFloat = 0, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func at(_ positions: [NamadaLayoutPosition], _ relation: LayoutRelation<InsetsConvertible>, to parent: ParentRelated, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    @discardableResult
    public func at(_ viewRelation: NamadaRelatedPosition, _ relation: LayoutRelation<InsetsConvertible>, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
    ...
    public func inBetween(of view: UIView, and otherView: UIView, _ position: NamadaMiddlePosition, priority: PriorityConvertible? = nil) -> Self {
        let priority: PriorityConvertible = priority ?? context.mutatingPriority
        switch position {
